...
export default function IOSStarterExport() {
  ...
  const downloadZip = async () => {
    try {
      ...
      toast.success("Downloaded — unzip and run `xcodegen generate`, then open in Xcode");
    } catch (e: any) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                Open the unzipped folder in Cursor / Xcode (after <code>xcodegen generate</code>).
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              <p>1. Unzip and (optionally) run <code>xcodegen generate</code> to produce the <code>.xcodeproj</code>.</p>
