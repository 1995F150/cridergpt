...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    pricing: "Free / $25+/mo",
    outputs: ["Web (React + Vite)", "Installable PWA"],
    bestFor: "Web apps, PWAs, dashboards, anything you want to also ship as a website",
    notes: "What you are using now. Best for the main CriderGPT platform and anything web-first. Native Android/iOS ships as separate Kotlin/Swift projects.",
    rating: 5,
  },
  {
    name: "Replit Agent",
...
const RECOMMENDATIONS: { type: string; pick: string; why: string }[] = [
  ...
  { type: "Web dashboard / admin tool", pick: "Lovable", why: "Already your stack; ships as an installable PWA." },
